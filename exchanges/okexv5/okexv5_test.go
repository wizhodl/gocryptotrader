...
func TestMain(m *testing.M) {
	...
	okexConfig.API.IsTestnet = os.Getenv("IS_TESTNET") == "1"
	okexConfig.API.Credentials.Key = os.Getenv("OKEXV5_APIKEY")
	okexConfig.API.Credentials.Secret = os.Getenv("OKEXV5_APISECRET")
	okexConfig.API.Credentials.ClientID = os.Getenv("OKEXV5_PASSPHRASE")
...
func TestGetOrder(t *testing.T) {
	...
	order, err := o.GetOrderInfo(request.OrderID, pair, asset.Spot)
