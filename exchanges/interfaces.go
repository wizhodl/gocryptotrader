...
type IBotExchange interface {
	...
	TransferAsset(from asset.Item, to asset.Item, assetStr string, amount float64) (string, error)
	GetPositions(a asset.Item, cp *currency.Pair) ([]position.Position, error)
}
